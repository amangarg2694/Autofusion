...
As a RxClaim User I want to update plan maintainance utility
   ...
   Scenario Outline: Update plan maintainance utility
    ...
    And verify plan details with "<SuperNDC>","<SuperGPI>" 
    ...
    |PlanCode   |Option1|Option2|Selection1|FirstRec| TemplateID | fromdate | DEAclasscode | DEAfromdate | Action |SuperNDCProcess|SuperGPIProcess|SuperNDCNewValue|SuperGPINewValue|ActPrc|ActExstVal|ActNewVal|DrgStsPrc|DrgStsExstVal|DrgStsNewVal|              
    |SR41568TWO |   2   |13     |    2     | 1      |   EC05 | 010191   |     1        |  010117     |    R   |   R           |R              |    RG41466D1   |    RG41466D1   |   C  |     Y    |    Y    |    C    |     F       |    F       |
