...
As a RxClaim User I want to update plan maintainance utility
   ...
   Scenario Outline: Update plan maintainance utility
    ...
    And I press "Enter" Key
    And verify DEAClassTwo is updated with "<SuperNDC>","<SuperGPI>" 
    ...
    |PlanCode   |Option1|Option2|Secondrec|Selection1| SuperNDC | SuperGPI | TemplateID | fromdate | DEAclasscode | DEAfromdate | Action |SuperNDCProcess|SuperGPIProcess|SuperNDCNewValue|SuperGPINewValue|ActPrc|ActExstVal|ActNewVal|DrgStsPrc|DrgStsExstVal|DrgStsNewVal|               
    |SR41568TWO |   2   |13     |  2      |    2     |  CMOL    | AJG35687 |   EC02 | 010191   |     2        |  010117     |    R   |   R           |R              |    RG41466D1   |    RG41466D1   |   C  |     Y    |    Y    |    C    |     F       |    F       |
