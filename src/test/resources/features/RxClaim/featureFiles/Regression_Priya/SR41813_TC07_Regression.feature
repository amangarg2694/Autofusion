...
Feature: Medicaid Subrogation Profile 
  ...
  Scenario Outline: Verify if claim is getting Paid and Notes related to override R75 should be stamped
    ...
    And I press "Enter" Key
    And I enter Part D plan with "<From Date>","<Thru Date>","<PlanCode>"
    And I press "F3" Key
    And I press "F3" Key
    And I press "F12" Key
    And I select Option "4" to navigate to "RxClaim Plan Maintenance"
      ...
      | SR41813AC | Carrier     |        712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | COMMERCIAL  | SR41813A1 | Account     | SR41813AC | Group    | 010101 | 123139 | SR41813YD |SR41813 Plan | SR41813XD | AUTOMEM    | AUTOMEM   | 12251987 | 777777 | * | SN002215 | APHARM | 310019947001 | 00     | 00310075139 |1      |1  |0   |10   | 010118 | 123118 | 10 | 10 | 1 | 17621929891 | B41813 | Test | B41813 | Testing | 9999 | 9999 | Y | Y | 010117 | 123117 | SR41813B9 |
