...
Feature: Medicaid Subrogation Profile 
  ...
  #Troop Schedule becomes inactive, therefore if you run this again with the same plan, it will fail. Also, need to use a plan that has TROOP schedule attached. 
  ...
  Scenario Outline: Verify if claim is getting Rejected with R75 and Notes related to override R75 should not be stamped Override flag as 'Y' and Non Part D plan
    ...
    And I create a Carrier List with "<CarrierID>"
  	And I press "F12" Key
   ...
   Examples:
      ...
      | SR41813AC | Carrier     |        712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | COMMERCIAL  | SR41813A1 | Account     | SR41813AC | Group    | 010101      | 123139      | SR41813A3 |SR41813 Plan | SR41813AD | AUTOMEM    | AUTOMEM   | 12251987 | 777777 | *       | SN002215 | APHARM   | 310019944001 | 00     | 00071015523 |1      |1   |0    |10    | 010101    | 123139    | 10  | 10  | 1    | 17621929891 | B41813 | Test | B41813    | Testing      | 9999 | 9999   | Y    | Y               |
