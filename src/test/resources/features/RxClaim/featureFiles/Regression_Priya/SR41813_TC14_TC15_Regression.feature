...
## Using PlanCode1 data from TC08 , PlanCode data from TC07
# Member ID, Payee and Profile ID needs to be updated before running the scripts, 
  ...
  Scenario Outline: Verify if claim is getting paid.Notes related to override R75 should be stamped.Override flag as 'Y'.Member and Group has different Non PartD plan attached.
    ...
    And I select Option "8" to navigate to "RxClaim Profile Maintenance"
		...
		And medicaid subrogation profile created with "<ProfileID>","<PDescription>","<SDWD>","<MCSDWD>","<Code>","<Payee>"
		And I press "F12" Key
 ...
 # TC15: Verify if claim is getting Rejected with R75.Notes related to override R75 should not be stamped.Override flag as 'N'.Member and Group has different Non PartD plan attached.
 		And I press "F3" Key
 		And I press "F12" Key
	  And I press "F12" Key
      ...
      | 41813BE | Carrier     |        712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | COMMERCIAL  | SR41813A1 | Account     | 41813BE | Group     |      010101 |      123139 | SR41813YD  |SR41813 Plan | 41813BH     | AUTOMEM    | AUTOMEM   | 12251987 | 777777 | *       | SN002215 | APHARM | 310019955001 | 00     | 00310075139 |1      |1  |0   |10   | 010101      | 123139     | Y              | 10 | 10   | 1     | 17621929891 | 41813BG | Test | 41813BG | Testing       | 9999 | 9999  | Y     | 41813A4 |
