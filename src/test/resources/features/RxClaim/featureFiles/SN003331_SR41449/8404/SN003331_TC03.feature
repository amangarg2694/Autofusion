Feature: A manual claim is submitted with medicaid subrogation
 ...
 Scenario Outline: SN003331_SR41449_TC003_Verify  manual claim when Medicaid Subrogation = N and Negative amount Due = Y
    ...
    And I enter "<Proc Ctr>" in field "Proc Ctr" on "AddTransactionwithPayeeOverride"
    And I enter "<Member ID>" in field "Member ID" on "AddTransactionwithPayeeOverride"
    ...
    Then Validate "Approved Due Amount" when Medicaid Subrogation = N and Negative amount Due = Y
      ...
      |$1.00			|Y								|777777	|SN003331	|SN003331	|apharm		|1099900861	|00	|AUTO3331M5	|SN003331VM			|N										|00247064407	|2				|3	|0		|5		|5				|
      
       #|$1.00|Y|777777|KDPCN|KDGRP|apharm|0709320397|00|mem842-01|kiranpayee|Y|00247064407|2|3|0|5|5|
