Feature: A manual claim is submitted with medicaid subrogation
 ...
 Scenario Outline: SN003331_SR41449_TC001_Verify if note is added to manual claim when Medicaid Subrogation = Y and Negative Amount Due = Y
    ...
    And I enter "<CostBasis>" in field "CostBasis" on "TransactionSubmissionPayeeOverride1of3"
    ...
    And I verify Approved Due Amount in "Price Information Page 1 of 3"
     ...
     #AUTO3331M1
      ...
      |$1.00			|Y								|777777	|SN003331	|SN003331 |apharm		|6454612336 	|00	|AUTO3331M2	|kiranpayee			|Y										|00247064407	|2				|3	|0	|5		|5				|	01			|
     
      #|$1.00			|Y								|777777	|KDPCN1		|KDGRP1	|apharm		|5632271657	|00	|SN003331K3-01	|kiranpayee			|Y										|00247064407	|2				|3	|0	|5		|5				|
