...
As a RxClaim User I want to check whether PMC codes are limited to 5 fields 
    
             
Scenario Outline: Verify PMC codes are limit to 5 fields (J, K, L, and M & N) and do not exceed this count
    ...
    | BIN     | ProcCtrl| Group | PharmacyID  |RxNo          | Refill | FillDate | MemberID     | ProductID  | DspQty | DS | PSC | Cost | Code1 | Code2 | Code3 | Code4 | Code5 | Code6 | Code7 | Code8 | Codelength | Library | Filename | FromDate | ThruDate | CarrierID | AccountID | GroupID | File1 | File2 | File3 | File4 | File5 | LibraryName | ExtractDate |
		|	888888  | HANDA1     |	HANDA1  | APHARM      | 100020007030 | 00     | 120717   | AB012726M01 | 53303003041 |1      |1  |00   |10  | 001 | 002 | 003 | 004 | 005 | 006 | 007 | 008 | 8 | TCL8402FIL | RCPMCP | 080118 | 083018 | 2726CAR | 2726AC01 | 2726GROUP03 | FILE16 | FILE17 | FILE18 |FILE19 | FILE20 | USRPRIYA | 080718 |
