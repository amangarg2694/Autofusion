...
As a RxClaim User I want to check whether PMC codes are limited to 5 fields and blank values are ignored
    
             
Scenario Outline: Verify PMC codes are limit to 5 fields (Blank, K, blank, M , blank, N) and do not exceed this count
    ...
    And I press "F12" Key
		And I press "F12" Key
    And I press "F3" Key
		Then updating the pmc code with "   ","<Code2>","   ","<Code4>","   ","<Code6>","   ","<Code8>","<Codelength>","<Library>","<Filename>"
    ...
    | BIN     | ProcCtrl| Group | PharmacyID  |RxNo          | Refill | FillDate | MemberID     | ProductID  | DspQty | DS | PSC | Cost | Code1 | Code2 | Code3 | Code4 | Code5 | Code6 | Code7 | Code8 | Codelength | Library | Filename | FromDate | ThruDate | CarrierID | AccountID | GroupID | File1 | File2 | File3 | File4 | File5 | LibraryName | ExtractDate |
		|	888888  | HANDA1     |	HANDA1  | APHARM      | 100020009000 | 00     | 120717   | AB012726M01 | 53303003041 |1      |1  |00   |10  | 001 | 001 | 002 | 002 | 001 | 001 | 002 | 002 | 8 | TCL8402FIL | RCPMCP | 080118 | 083018 | 2726CAR | 2726AC01 | 2726GROUP03 | FILE100 | FILE101 | FILE102 |FILE103 | FILE104 | USRPRIYA | 080718 |
