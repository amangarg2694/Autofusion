...
As a RxClaim User I want to check plan tier in formulary screen for DPA 
  ...
  Scenario Outline: Flag is exclude and tier does not match the plan tier for DPA
    ...
    Examples:
      ...
      | T1621 | A1621 | G1621 | TESTDYNAMI  | 414291D | AUTOMEM    | AUTOMEM   | 12251987 | 777777 | CCHA | *ALL    | GACH | 200040000000 | 00     | 7252018   | 00054014225 | 90    | 90 | 0   | 010118 | 123118 | 66785887807 | 1 | 1 | N | 2 | 0 | F | AA | N | a | Y | N | AKUR LIST | A | 04 | 04 | E | 01 |
