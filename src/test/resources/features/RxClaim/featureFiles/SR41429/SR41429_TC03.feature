...
As a RxClaim User I want to check plan tier in formulary screen for MPA 
  ...
  Scenario Outline: Flag is include and the tier matches the plan tier for MPA
  	Given I am on RxClaim PlanAdministrator Menu
  	When I select Option "1" to navigate to "RxClaim Eligibility/Claim Transaction Maintenance"
  	And I select Option "2" to navigate to "Active/Eligible Member by ID"
  	Then I edit details of PA in member screen with "<MemberID>","<Data>","<TierOverride>"
  	And I press "F12" Key
      ...
      | MemberID   | First Name | Last Name | BIN    | PCN     | Group | Pharmacy |RxNo          | Refill | FillDate | ProductID  | DspQty | DS | PSC | Cost | From Date | Thru Date | UCW | Data | TierOverride |
      | SR41429_02 | AUTOMEM    | AUTOMEM   | 777777 | CCHA | *ALL    | WALMARTIL | 100010000004 | 00     | 7192018   | 00363012020 |30      |30  |0   |100   | 010101 | 123139 | 100 | 06 | I |
