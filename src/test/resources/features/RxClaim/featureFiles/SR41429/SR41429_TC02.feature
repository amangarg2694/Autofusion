...
As a RxClaim User I want to check plan tier in formulary screen for MPA 
  ...
  Scenario Outline: Flag is Exclude and the tier does not match for MPA
      ...
      | MemberID   | First Name | Last Name | BIN    | PCN     | Group | Pharmacy |RxNo          | Refill | FillDate | ProductID  | DspQty | DS | PSC | Cost | From Date | Thru Date | UCW | Data | 
      | SR41429_02 | AUTOMEM    | AUTOMEM   | 777777 | CCHA | *ALL    | WALMARTIL | 100010000002 | 00     | 7192018   | 00363012020 |30      |30  |0   |100   | 010101 | 123139 | 100 | 05 |
