...
As a RxClaim User I want to check plan tier in formulary screen for DPA 
  ...
  Scenario Outline: Flag is include and tier does not match the plan tier for DPA
    ...
    Then I create DPA for entering the plantier details with "<CarrierID>","<SubmittedPA>","<PANum>","<Description>","<UsageType>","<ApplyMIC>","<Type>","<Wildcard>","<From Date>","<Thru Date>","<Basis>","<ReasonCode>","<Utilization>","<PA>","<DrugSts>","<PAGPIList>","<Sts>","<Agent>","<Tier>","<Formulary Status>","<TierOverride>","<Data>"
    ...
    Examples:
      ...
      | CarrierID | AccountID | GroupID  | PlanCode | MemberID   | First Name | Last Name | DOB      | BIN    | PCN     | Group | Pharmacy |RxNo          | Refill | FillDate | ProductID  | DspQty | DS | PSC | From Date | Thru Date | PANum | SubmittedPA | UsageType | ApplyMIC | Type | Wildcard | Basis | ReasonCode | Utilization | Agent | PA | DrugSts | PAGPIList | Sts | Tier | Formulary Status | TierOverride | Data |
      | T1621 | A1621 | G1621 | TESTDYNAMI  | SR41429A | AUTOMEM    | AUTOMEM   | 12251987 | 777777 | CCHA | *ALL    | GACH | 200050000000 | 00     | 7252018   | 00054014225 | 90    | 90 | 0   | 010118 | 123118 | 66785887807 | 1 | 1 | N | 2 | 0 | F | AA | N | a | Y | N | AKUR LIST | A | 01 | 04 | I | 05 |
