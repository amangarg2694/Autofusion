Feature:  Verify  the  external Transaction Number for XTR Transaction Type=5 for Reversed Claims
  As a RxClaim User I want to check XTR Transaction Type for reversal claims

  Scenario Outline: Verify  the  external Transaction Number for XTR Transaction Type=5 for Reversed Claims
    ...
    Then Validate External Transaction format on ExternalTransactionScreen
     ...
     Examples: 
      | BIN     | ProcCtrl| Group | PharmacyID  |RxNo          | Refill | FillDate | MemberID     | ProductID  | DspQty | DS | PSC | Cost | Carrier | Account | Groupid | First Name | Last Name | DOB      | Start Date | End Date  |  
		|	777777  | SR41634     |	*  | APHARM      | 900019931202 | 00     | 6252018   | SR41632_RP3 | 00071015523|2      |2  | 0 | 100   | SR41632CZ | SR41632A1 | SR41632GG | AUTOMEM    | AUTOMEM   | 12251987 |    010101 |    123139 |
