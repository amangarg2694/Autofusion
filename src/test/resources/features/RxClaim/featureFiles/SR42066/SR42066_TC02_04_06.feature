...
Feature: SN003425_SR42066:PART D: February 2018 Updates to the Drug Data Processing System
 ...
 #@Regression
  Scenario Outline: SN003425_SR42066_TC002_Req 4.2:Validate the compound code on PDE 1070 when the PDE  is submitted for a cliam with compound code  0
  								  SN003425_SR42066_TC004_Req 4.2:Validate the compound code on PDE 1070 when the PDE  is submitted for a cliam with compound code  1
  								  SN003425_SR42066_TC006_Req 4.2:Validate the compound code on PDE 1070 when the PDE  is submitted for a cliam with compound code  2
    ...
    |Cmpnd|BIN    |ProcCtrl|Group 	|PharmacyID|RxNo         |Refill |FillDate |MemberID	  |ProductID  |DspQty |DS |PSC |Cost |ExtractDate |wsQuery|ExtractJobName|Extractstatus|FromDate|ThruDate|CarrierID|Library|DDPSFilterProcess|SubmitterID|Compoundcode|JobRCPD 	|Fromfile |Option|Createfile|InputFileName|DDPSFilterProcessR|
	 #|0		|777777 |SR42066 |SR42066 |APHARM    |765765367432 |00     |060118   |SR42066AUTO1|00777310402|30     |30 |00  |100  |122718		  |ws		  |EXTRACTJOB		 |BLANK 			 |010118  |123138	 |SR42066C |ANMISHA|N							   |T42066	   |1				  	|RCPD1070	|SR42066M0|*ADD	 |*YES			|SR42066M0		|N								 |
	 #|1		|777777 |SR42066 |SR42066 |APHARM    |765765367432 |00     |060118   |SR42066AUTO1|00777310402|30     |30 |00  |100  |122718		  |ws		  |EXTRACTJOB		 |BLANK				 |010118  |123138	 |SR42066C |ANMISHA|N							   |T42066	   |1 			  	|RCPD1070	|SR42066M0|*ADD	 |*YES			|SR42066M0		|N								 |
	  |2		|777777 |SR42066 |SR42066 |APHARM    |765765367432 |00     |060118   |SR42066AUTO1|00777310402|30     |30 |00  |100  |122718		  |ws		  |EXTRACTJOB		 |BLANK				 |010118  |123138	 |SR42066C |ANMISHA|N							   |T42066	   |2				  	|RCPD1070	|SR42066M0|*ADD	 |*YES			|SR42066M0		|N								 |
