...
Scenario Outline: Verify Plan Qualifier is Blank
...
Examples:
	...
	|181805045241000 |BPE-TOC|             |

	
Scenario Outline: Verify Transition of Care (TOC) Indicator is Y
...
|900019931004  |BPE-TOC MBR 1 |       |N       |Y       |