Feature: FIX IT: BATCH: Omnicom POS Rebates - Quarterly Reporting
  ...
  Scenario Outline: SN374533_SR41836_TC001:Adjudicate the claim with rebate amount setup and prescriber submitted is NPI.
  									SN374533_SR41836_TC002:Run the batch POS Rebate Claims Extract 
    ...
    | BIN     | ProcCtrl   |	Group      | PharmacyID  |RxNo          | Refill | FillDate | MemberID     | ProductID   | DspQty | DS | PSC | Cost |DateFrom|DateThru|CarrierFrom|CarrierThru|AccountFrom|AccountThru|GroupFrom|GroupThru|Netpaidonly|Paid|Rejected|Reversed|Captured|FileName|Library |
		|	777777  | SN000869PC |	SN000869G1 | 1476969     | 765431378433 | 00     | 080518   | SN000869MEM3 | 37000051106 |30      |30  |00   |100   |010101  |123139	|SN000869C  |SN000869C  |SN000869A  |SN000869A	|SN000869G|SN000869G| N					| Y  | N			| N			 |   N		|DTEST01 |ANILALIB|
