@NonMedDValidation_ExceptionCode_P
Feature: Pricing exception code 
  ...
  Examples:
      ...
      | SR41787Z2 | Carrier     |       712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | *DEFAULT     | SR41787A1 | Account     | SR41787C3 | SR41787C4 | Group     |      010101 |      123139 | SR41787CA3  | 41787CA4 | COB1 NonMed Plan | COB2 NonMed Plan | SR41787_X3 | SR41787_X4 | AUTOMEM    | AUTOMEM   | 12251987 | 777777 | AKAN | *     | APHARM      | 200019931002 | 00     | 7042018   | 00071015523|2      |2  |0   |100   | 200019931003 |
       
      
  @PDE_Job
  
   Scenario Outline: Triggering the PDE when the Exception code of P is selected and the network ID is  populated and the COB indicator is 1 and not 1 for a non-Med D claim  
    And I press "F3" Key
    And I press "F3" Key
    When I select Option "20" to navigate to "RxClaim Plan Administrator Menu"
		And I select Option "1" to navigate to "RxClaim Eligibility/Claim Transaction Maintenance"
   ...
   Examples:
      ...
      | CarrierID | AccountID | GroupID  | GroupID2  | MemberID   | MemberID2 | PDEFromDt | PDEThruDt | Library | DDPSCodeList | SubmitterID | PEC |
      | SR41787Z2 | SR41787A1 | SR41787C3 | SR41787C4 | SR41787_X3 | SR41787_X4 | 070318 | 070418 | USRPRIYA | AGR     | S41787 | P |
       
  @Validation
   
  Scenario Outline: Verify the Pricing exception code when the Exception code of P is selected and the network ID is populated and the COB indicator is 1 and not 1 for a non-Med D claim
    When I select Option "20" to navigate to "RxClaim Plan Administrator Menu"
		And I select Option "1" to navigate to "RxClaim Eligibility/Claim Transaction Maintenance"
		And I select Option "2" to navigate to "Active/Eligible Member by ID"
		And I enter "<MemberID>" in field "MemberIDSearch" on "MemberDetailScreen"
