...
Feature: Pricing exception code 
  ...
  Scenario Outline: Verify the Pricing exception code when the Exception code of N is selected and the network ID is populated and the COB indicator is not 1 for a med D claim
    ...
    And I press "Enter" Key
    And I enter "Y" in field "PharmacyNetwork" on "PlanDetailScreen"
    And I enter "Y" in field "Accumulator" on "PlanDetailScreen"
    And I press "F7" Key
    And I enter "4" in field "Selection" on "PlanOptionsScreen"
    And I press "Enter" Key
    And I enter "4" in field "Option" on "ActivePlanPharmacyNetworks"
    And I press "Enter" Key
    And I enter "Y" in field "ConfirmPrompt" on "ActivePlanPharmacyNetworks"
    And I press "F6" Key
    And I press "F16" Key
    And I enter "<CarrierID>" in field "CarrierID" on "ActivePlanPharmacyNetworks"
    And I press "Enter" Key
    And I enter "1" in field "Selection" on "ActivePlanPharmacyNetworks"
    And I press "Enter" Key
    And I enter "100" in field "Seq" on "ActivePlanPharmacyNetworks"
    And I press "Enter" Key
    And I press "F12" Key
		And I press "F12" Key
    And I press "F12" Key
    ...
    And I press "F3" Key
    And I press "F12" Key
    When I submit a COB claim with "<BIN>","<PCN>","<Group>","<Pharmacy>","<RxNo>","<Refill>","<FillDate>","<MemberID>","<ProductID>","<DspQty>","<DS>","<PSC>","<Cost>"
    ...
    Examples:
      ...
      | SR417873C | Carrier     |       712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | *DEFAULT     | SR41787A1 | Account     | SR417873C | Group     |      010101 |      123139 | SR417873C  |COB2 NonMed Plan | SR41787_3C | AUTOMEM    | AUTOMEM   | 12251987 | 777777 | AKAN | *    | FIRMC | 500019941001 | 00     | 7042018   | 00071015523|2      |2  |0   |100   | 010101 | 123139 | D1002 | 100 | 10009 | 2018 | 20001 | APharm | SR41787 | Pharmtest | 10001000 | 070318 | 070418 | USRPRIYA | AGR     | N | M |
