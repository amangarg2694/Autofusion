...
Feature: Rejection Code for State Medicaid Program 
  ...
  Scenario Outline: Verify  non medicaid Pharmacy Negative network will return the Reject code 50
   	Given I am on RxClaim PlanAdministrator Menu
   	When I select Option "4" to navigate to "RxClaim Plan Maintenance"
		And I select Option "1" to navigate to "Active Plan by Plan Code"
		And I enter "SR410105E" in field "PlanCode" on "ActivePlanbyPlanCodeScreen"
		...
		And I press "Enter" Key
	  And I press "F18" Key
	  And I enter "N" in field "Medicaid Network" on "PharmacyNetworkOverride"
	  And I delete CCR code
	  And I press "F12" Key
	  And I press "F3" Key
	  And I press "F3" Key
	  And I press "F3" Key
	...
	Examples:
      ...
      | CarrierID | CarrierName | Processor | MailingAdd | City      | State | Zip   | ContractFromDt | ContractThruDt | ContractEnt | BusinessType | AccountID | AccountName | GroupID  | GroupName | GroupFromDt | GroupThruDt | PlanCode | Description | MemberID   | First Name | Last Name | DOB      | BIN    | PCN     | Group | Pharmacy |RxNo          | Refill | FillDate | ProductID  | DspQty | DS | PSC | Cost | From Date | Thru Date | PlanFromDt |
      | SR410105E | Carrier     |       712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | *DEFAULT     | SR41010A1 | Account     | SR410105E | Group     |      010101 |      123139 | SR410105G  |SR41010 Pharmacy Plan | SR41010_5E | AUTOMEM    | AUTOMEM   | 12251987 | 265510 | 265510 | *    | 0556540 | 100019958010 | 00     | 12032018   | 00777310402 |5      |5  |0   |100   | 010101 | 123139 | 010110 |
