...
Feature: Rejection Code for State Medicaid Program 
  ...
  Scenario Outline: Verify New Reject code 889 when Prescriber not in the Plan Prescriber network
	...
	Examples:
      ...
      | CarrierID | CarrierName | Processor | MailingAdd | City      | State | Zip   | ContractFromDt | ContractThruDt | ContractEnt | BusinessType | AccountID | AccountName | GroupID  | GroupName | GroupFromDt | GroupThruDt | PlanCode | Description | MemberID   | First Name | Last Name | DOB      | BIN    | PCN     | Group | Pharmacy |RxNo          | Refill | FillDate | ProductID  | DspQty | DS | PSC | Cost | From Date | Thru Date | PlanFromDt | NetworkID | PresQual | PrescriberID |
      | SR4101007 | Carrier     |       712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | *DEFAULT     | SR41010A1 | Account     | SR41010A7 | Group     |      010101 |      123139 | SR41010P8  |SR41010 PrescriberPlan | SR41010_1G | AUTOMEM    | AUTOMEM   | 12251987 | 265510 | 265510 | *    | APHARM | 100019951005 | 00     | 12032018   | 00247064407 |5      |5  |0   |100   | 010101 | 123139 | 010110 | KSID01 | 08 | A-097778 |
