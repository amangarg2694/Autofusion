...
Feature: Rejection Code for State Medicaid Program 
  As a RxClaim User I want to check claim is paid

  Scenario Outline: Verify the Override New Reject code 890 by submitting the new Submission Clarification code 56
    ...
    And I enter "4" in field "Selection" on "PlanOptionsScreen"
	  ...
	  And I press "F3" Key
	  And I press "F12" Key
	  When I submit a CCR claim with "<BIN>","<PCN>","<Group>","<Pharmacy>","<RxNo1>","<Refill>","<FillDate>","<MemberID>","<ProductID>","<DspQty>","<DS>","<PSC>","<Cost>","<CCR>"
	...
	Examples:
      ...
      | CarrierID | CarrierName | Processor | MailingAdd | City      | State | Zip   | ContractFromDt | ContractThruDt | ContractEnt | BusinessType | AccountID | AccountName | GroupID  | GroupName | GroupFromDt | GroupThruDt | PlanCode | Description | MemberID   | First Name | Last Name | DOB      | BIN    | PCN     | Group | Pharmacy |RxNo          | Refill | FillDate | ProductID  | DspQty | DS | PSC | Cost | From Date | Thru Date | PlanFromDt | CCR | RxNo1 |
      | SR410103I | Carrier     |       712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | *DEFAULT     | SR41010A1 | Account     | SR410103I | Group     |      010101 |      123139 | SR410103I |SR41010 Pharmacy Plan | SR41010_3I | AUTOMEM    | AUTOMEM   | 12251987 | 265510 | 265510 | *    | APHARM | 100019956013 | 00     | 12032018   | 00247064407 |5      |5  |0   |100   | 010101 | 123139 | 010110 | 56 | 100019956014 |
