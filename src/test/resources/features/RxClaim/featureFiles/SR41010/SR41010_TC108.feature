...
Feature: Rejection Code for State Medicaid Program 
  ...
  Scenario Outline: Verify the Override New Reject code 890 by submitting the new Submission Clarification code 56
    ...
    And I press "F3" Key
    And I press "F12" Key
    When I submit a CCR claim with "<BIN>","<PCN>","<Group>","<Pharmacy>","<RxNo>","<Refill>","<FillDate>","<MemberID>","<ProductID>","<DspQty>","<DS>","<PSC>","<Cost>","<CCR>"
    Then Validate Claim Status is "P"
    
	Examples:
   
      | CarrierID | CarrierName | Processor | MailingAdd | City      | State | Zip   | ContractFromDt | ContractThruDt | ContractEnt | BusinessType | AccountID | AccountName | GroupID  | GroupName | GroupFromDt | GroupThruDt | PlanCode | Description | MemberID   | First Name | Last Name | DOB      | BIN    | PCN     | Group | Pharmacy |RxNo          | Refill | FillDate | ProductID  | DspQty | DS | PSC | Cost | From Date | Thru Date | PlanFromDt | CCR |
      | SR410102A | Carrier     |       712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | *DEFAULT     | SR41010A1 | Account     | SR410102A | Group     |      010101 |      123139 | SR410102A  |SR41010 PrescriberPlan | SR41010_2A | AUTOMEM    | AUTOMEM   | 12251987 | 265510 | 265510 | *    | APHARM | 100019955000 | 00     | 12032018   | 00247064407 |5      |5  |0   |100   | 010101 | 123139 | 010110 | 56 |
