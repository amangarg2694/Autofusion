Feature: SR41384: WO: Plan Code Conversion Request
   ...
   Scenario Outline: SR40892_TC02_ Verifying if Plan Code "P" and Durg Sts " G" &  Multi source ind " N" then Tier Value "4" should be populated at 310 position in BCBSAZ Paid Claim File. 
