Feature: SR41384: WO: Plan Code Conversion Request
    ...
    Scenario Outline: SR40892_TC09_ Verifying if Plan Code "P" and Durg Sts " G" &  Multi source ind " M" then Tier Value "4" should be populated at 247 position in BCBSAZ Paid Claim File. 
    ...
    | BIN     | ProcCtrl | Group  | PharmacyID  |	RxNo         | Refill | FillDate | MemberID  | ProductID  | DspQty | DS  | PSC | Cost |Fee|DateFrom|DateThru|CarrierFrom|CarrierThru|AccFrom  |AccThru  |GrpFrom  |GrpThru  |Filename |Libname   |
		|	777777  | AKAN     |	*     | APHARM      | 222141255566 | 00     | 081418   |SR41320DSK | 59676031000| 10     |	10 | 00  |100   |10 |010118  |123118  | SR41320C1	| SR41320C1	|SR41320A1|SR41320A1|SR41320G1|SR41320G1|SR41320SH|USRSANDEEP|
