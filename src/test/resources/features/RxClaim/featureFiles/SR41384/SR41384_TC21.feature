Feature: SR41384: WO: Plan Code Conversion Request
    ...
    Scenario Outline: SR40892_TC21_ Verifying if Plan Code "S" and Durg Sts " G" &  Multi source ind " M " then Tier Value "D" should be populated at 5192 position in BCBSAZ Custom Claim Extract file.   
    ...
    Then I verify the "Tier Value "D" should be populated at 5192 position in BCBSAZ Custom Claim Extract file
    ...
    | BIN     | ProcCtrl | Group  | PharmacyID  |	RxNo         | Refill | FillDate | MemberID    | ProductID | DspQty | DS  | PSC | Cost |Fee|DateFrom|DateThru|CarrierFrom|CarrierThru|AccFrom  |AccThru  |GrpFrom  |GrpThru  |ExRej|Pricing|Filename  |Libname   |
		|	777777  | AKAN     |	*     | APHARM      | 733241554345 | 00     | 081418   |SR41320SHASHI|59676031000| 10     |	10  | 00  |100   |10 |010118  |123118  | SR41320C1 | SR41320C1 |SR41320A1|SR41320A1|SR41320G1|SR41320G1|   Y |    N  |SR41320DS |USRSANDEEP|
