Feature: SR41384: WO: Plan Code Conversion Request
    ...
    Scenario Outline: SR40892_TC16_ Verifying if Plan Code "S" and Durg Sts " G" &  Multi source ind " Y" then Tier Value "D" should be populated at 247 position in BCBSAZ Paid Claim File. 
    ...
    | BIN     | ProcCtrl | Group  | PharmacyID  |	RxNo         | Refill | FillDate | MemberID  | ProductID | DspQty | DS  | PSC | Cost |Fee|DateFrom|DateThru|CarrierFrom|CarrierThru|AccFrom  |AccThru  |GrpFrom  |GrpThru  |Filename |Libname   |
		|	777777  | AKAN     |	*     | APHARM      | 923241233241 | 00     | 081418   |SR41320_M2 |00000124671| 10     |	10  | 00  |100   |10 |010118  |123118  | SR41320C1	| SR41320C1	|SR41320A1|SR41320A1|SR41320G1|SR41320G1|SR41384F2|USRSANDEEP|
