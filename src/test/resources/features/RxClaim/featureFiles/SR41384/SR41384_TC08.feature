Feature: SR41384: WO: Plan Code Conversion Request
    ...
    Scenario Outline: SR40892_TC08_ Verifying if Plan Code "S" and Durg Sts " G" &  Multi source ind " Y" then Tier Value "D" should be populated at 310 position in BCBSAZ Paid Claim File. 
    ...
    And I select Active Product to set Multi source ind as Y
    And I select Option "20" to navigate to "RxClaim Plan Administrator Menu"
    ...
    Then I verify the "Tier Value "D" should be populated at 310 position in BCBSAZ Paid Claim File. "
    ...
    | BIN     | ProcCtrl | Group  | PharmacyID  |	RxNo         | Refill | FillDate | MemberID          | ProductID  | DspQty | DS  | PSC | Cost |Fee|DateFrom|DateThru|CarrierFrom|CarrierThru|ProdList|SponserCode|Filename |Libname   |
		|	777777  | AKAN     |	*     | APHARM      | 222284333287 | 00     | 081418   |VSRSASFLMMEDICAID1 | 00000124671| 10     |	10 | 00  |100   |10 |010118  |123118  | VSRSAS		| VSRSAS		| ALAZ   |   0000		 |SR41384F1|USRSANDEEP|
