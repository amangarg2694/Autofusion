Feature: SR41384: WO: Plan Code Conversion Request
    ...
    Scenario Outline: SR40892_TC24_ Verifying if Plan Code "S" and Durg Sts " G" &  Multi source ind " Y " then Tier Value "D" should be populated at 5192 position in BCBSAZ Custom Claim Extract file.   
