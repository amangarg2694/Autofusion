    ...
    Then I verify TrOOP/Drug Spend Accumulation Phase Details
	 ...
	 Examples: 
   	| PlanCode 		| NonPartDCovered	|	 PriceSchedule | NDC1 			 | NDC2				|	NDC3				| MemberID 	| BIN     | ProcCtrl| Group | PharmacyID  | RxNo         | Refill | FillDate | MemberID   |	Qual	| ProductID 	|	DspQty | DS | PSC | Cost |	Cmpnd	|	Qualifier1	|	NDC1					|	Quantity1	|	Cost1	|	BasicCost1|	Qualifier2	|	NDC2				|	Quantity2	|	Cost2	|	BasicCost2|
		| PLAN2643S3	| 0								|  PRCSCH2647		 | 00087134541 |51927486300	| 00006073531	| PUJANEW		| 777777  | QET     |	*ALL  | APHARM      | 209334985759 | 00     | 091718   | PUJANEW		|	00		|	0000000000	|	30     | 30 | 0	  | 000  |	2			|	03					|	00087134541		|	30				|	30		|	01				| 03					|	51927486300 |	10				|	10		|	01				|
