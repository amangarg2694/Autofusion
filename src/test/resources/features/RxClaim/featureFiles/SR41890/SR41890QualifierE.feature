Feature: Part D claims
   Scenario Outline: Create a new member in RxClaim with existing CAG for Medicare Part D 
    ...
    | CarrierID| AccountID   | GroupID    | MemberID     | First Name   | Last Name    | DOB       | From Date | Thru Date   |SupplyType|SupplyID|MMDFromDate|MMDThruDate|Contract|SubsidyLevel|CopayCat|
		|	2CAR3036  | 2ACC3036   |	2GRP3036  | SN3036DEMO99 | JOSHY        | MEM          | 01011970	 | 010101    | 123139      |   06     |SN3036  |010118     |123118     |A3036   |000         |0       |
   ...
   Scenario Outline: Pre Claim Submission Scenario 1
    ...
    | BIN     | ProcCtrl| Group | PharmacyID  |RxNo           | Refill | FillDate | MemberID     | ProductID  | DspQty | DS | PSC | Cost |PRC|
		|	777777  | CCHA    |	*ALL  | APHARM      | 111131321231 | 01     |050118    | SN3036DEMO99     | 00093754206 |30       |30  |0   |10   |03|
    ...
    Then Validate Claim Status is "P"
      ...
      Examples:
    | BIN     | ProcCtrl| Group | PharmacyID  |RxNo         | Refill | FillDate | MemberID     | ProductID   | DspQty | DS | PSC | Cost |PRC|
		|	777777  | CCHA    |	*ALL  | APHARM      |111131321232 | 01     |060118    | SN3036DEMO99  | 00002322730  |30      |30  |0    |10    |01|
    ...
    Then Validate Claim Status is "P"
      ...
      Examples:
    | BIN     | ProcCtrl| Group | PharmacyID  |RxNo          | Refill | FillDate | MemberID     | ProductID   | DspQty | DS | PSC | Cost |PRC|
		|	777777  | CCHA    |	*ALL  | APHARM      | 111131321233 | 01     |062918    | SN3036DEMO99     | 00093754206 |1       |1   |0    |10    |03 |
    ...
    Then Validate Claim Status is "P"
      ...
      Examples:
    | BIN     | ProcCtrl| Group | PharmacyID  |RxNo         | Refill | FillDate | MemberID     | ProductID   | DspQty | DS | PSC | Cost |PRC|
		|	777777  | CCHA    |	*ALL  | APHARM      |111131321234 | 01     |062918    | SN3036DEMO99  | 00002322730 |30      |30  |0    |10    |01 |
