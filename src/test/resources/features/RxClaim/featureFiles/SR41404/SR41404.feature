...
Scenario:  Validating new menu item Eligibility Load Tracking Extract in RxClaim Utility Programs
...
Scenario: Validating Eligibility Load Tracking Extract screen
...
Scenario: Validating help message and length of the field Form Date  
...
Scenario: Validating help message and length of the File Name field  
Given I am on Eligibility Load Tracking Extract screen
When I navigate to the field File Name
Then Validate the help message and length of the field File Name


Scenario: Validating help message and length of the Library field  
Given I am on Eligibility Load Tracking Extract screen
When I navigate to the field Library
Then Validate the help message and length of the field Library


Scenario: Validating the function keys F3 of Eligibility Load Tracking Extract screen   
Given I am on Eligibility Load Tracking Extract screen
When I press "F3" Key
Then User should navigate to RxClaim Utility Programs


Scenario: Validating the function keys F12 of Eligibility Load Tracking Extract screen   
Given I am on RxClaim Utility Programs
