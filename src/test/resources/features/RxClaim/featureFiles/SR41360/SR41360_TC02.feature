...
Scenario Outline: Verify and compare the Option 2=EDIT functionality on 'RCPTF041' screen in 8.4.02 and 8.4.01 environments.
  ...
  Then Verifying the edit functionality on price table screen with "<Environment>" and "<PriceTable>"
  And I press "F3" Key
	And I press "F3" Key
  And I press "F3" Key
  Then Verifying the edit functionality on price table screen with "<Regression>" and "<PriceTable>"
