...
Scenario Outline: Verify and compare the 'RCPTF041I' screen options & functionality in 8.4.02 and 8.4.01 environments.    
  ...
  When I select Option "1" to navigate to "RxClaim Eligibility/Claim Transaction Maintenance"
	...
	Then Validating RCPTF041I screen options and functionality with "<Environment>","<MemberID>"
	And I press "F3" Key
	And I press "F3" Key
	And I press "F3" Key
	And I press "F3" Key
	...
	And I press "F3" Key
	And I press "F3" Key
	Then Validating RCPTF041I screen options and functionality with "<Regression>","<Member>"
