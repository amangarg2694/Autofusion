...
Scenario Outline: Verify and compare the Option 4=Inactivate functionality on 'RCPSC002' screen in 8.4.02 and 8.4.01 environments.   
  ...
  When I select Option "5" to navigate to "RxClaim Price Maintenance"
	...
	Then Verify the inactivate functionality in price schedule criteria screen using "<Environment>"
	And I press "F3" Key
	And I press "F3" Key
  And I press "F3" Key
  And I press "F3" Key
  Then Verify the inactivate functionality in price schedule criteria screen using "<Regression>"
