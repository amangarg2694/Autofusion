Feature: Price Table by description
 ...
 Scenario Outline: Verify and compare the Option 5=Display functionality on 'RCPTF041' screen in 8.4.02 and 8.4.01 environments. 
  ...
  Then Verifying the Display functionality on price table screen with "<Environment>","<PriceTable>"
  And I press "F3" Key
	And I press "F3" Key
  And I press "F3" Key
  Then Verifying the Display functionality on price table screen with "<Regression>","<PriceTable>"
