Feature: Create New Plan with NDC and GPI List for TC001
 As a RxClaim User I want to create Plan with NDC List 
    ...
    Scenario Outline: Verify Compound claim is rejected with reason code 70 when Plan edit 9=Compounds set to 'N'and Set Compound Drig Status to R in NDC & GPI level(SN003374_SR41877_TC001_Req_8.1)
     ...
     Examples: 
     |PlanCode  |NDCList  | Status1 | Status2 |GPIList |ID1          |ID2           |ID3           |ID4           |PFromDate|PThruDate| CarrierID  | CarrierName |Processor  |MailingAdd|City|State|Zip  |ContractFromDt|ContractThruDt|ContractEnt| BusinessType |AccountID  |AccountName | GroupID   |GroupName  |GroupFromDt|GroupThruDt|PlanCode | MemberID  |FirstName |LastName  |DOB      |MemFromDate|MemThruDate|PANumber |Type|NDCGPIList     |From  |Thru   |Agent|Reason|IgnoreDrugStatus| BIN     | ProcCtrl | Group | PharmacyID  | RxNo          | Refill | FillDate | MemberID     | ProductID  | DspQty | DS | PSC | Cost | UCW |compQualID_1|compQuantity_1|compCost_1|compBasisOfCost_1|compQualID_2|compQuantity_2|compCost_2|compBasisOfCost_2|ClaimStatus|DrugStatus|RejectCode|RejectMessage |
     |Planpass07|NDCL01   | R       | F       |GPIL01  |88512606010  |88512705010   |00002197590   |00002322730   |010101   |123139   | SR41710AC1 | SR41710AC1  |712        |MAIL ADD  |City|IL   |78654|010101        |123139        |*DEFAULT   |*DEFAULT      |SR41710AA1 |SR41710AA1  | SR41710AG1|SR41710AG1 |010101     |123139     |SR41710C1| SR41710AM1|SR41710AM1|SR41710AM1|01011988 |010101     |123139     |SR41710P1|3   |00000000000000 |010101|123139 |O    |AC    |N               | 777777  | ASHE     |*      | APHARM      | 165488397000  | 00     | 090618   | AUTOMEMBER03 | 00000000000|30      |30  |0    | 100	 |100  |01          |1             |45        |00               |02          |2             |46        |01               |R          |R         |70        |Prod/Service Not Covered | 
