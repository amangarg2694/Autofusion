...
# Update new Plancode, Plan Description, NDCList, NDCDesc 
    ...
    |PlanReg33 |010110 |123139    |PlanReg33 NDCLST |EVUAREG      |EVUAREG           |RDCL33 |RDCL33  |20    |	010118  	 |123139        | M       |
...
Scenario Outline: Verify Compound claim is accepted for NDC when Member PA compound set to Y for Drug Status(SN003374_SR41877_TC018_Req_8.1)
    ...
    # Update PlanCode, NDCList as per above,Carrier ID, CarrierName,AccountID, AccountName, Group Id, GroupName, MEMBERId,MemberFirst and last name, PANumeer and filldate   
     ...
     |PlanReg33|RDCL33   | R       | F       |88512606010  |88512705010   |010101   |123139   | R41877C15  | R41877C15   |712        |MAIL ADD  |City|IL   |78654|010101        |123139        |*DEFAULT   |*DEFAULT      |S41877A15  |S41877A15   | S41877G15 |S41877G15  |010101     |123139     | RR41877M49 |RR41877M49 |RR41877M49  |01011988 |010101     |123139     |SR41877P49|3   |00000000000000 |010101|123139 |O    |AC    |N               | 777777  | ASHE     |*      | APHARM      | 165488397000  | 00     | 092018   | 00000000000|30      |30  |0    | 100	|100  |01          |20            |45        |00               |02         |30             |46        |01               |R          |R         |70        |Prod/Service Not Covered   |Y      |P           |f          | 
...
Scenario Outline: Verify Compound claim is accepted for NDC with added messages before and after when Member PA compound set to Y for plan CMI M(SN003374_SR41877_TC020_Req_8.1)
     ...
     |PlanReg33|RDCL33   | F       | F       |88512606010  |88512705010   |010301   |123139   | SLOI |SLOI2 | R41877C15 | R41877C15   |712        |MAIL ADD  |City|IL   |78654|010101        |123139        |*DEFAULT   |*DEFAULT      |S41877A15  |S41877A15   | S41877G15 |S41877G15  |010101     |123139     | RR41877M51 |RR41877M51 |RR41877M51  |01011988 |010101     |123139     |SR41877P32|3   |00000000000000 |010101|123139 |O    |AC    |N               | 777777  | ASHE     |*      | APHARM      | 165488397000  | 00     | 092018   | 00000000000|30      |30  |0    | 100	 |100  |01          |20             |45        |00               |02         |30             |46        |01               |P          |F         |Y      |P           |f         |Have more proteins!!!|Drink a cup of water every 17.2 seconds| 
