...
Scenario Outline: Create a new Plan with NDC GPI List in RxClaim  
    ...
    |Plnregr33|010110  |123139   |Plnregr33 NDCGPILST |EVUAREG      |EVUAREG           |RDCL43 |RDCL43 |10    |	010118  	  |123139        | L       |
...
Scenario Outline: Verify Compound claim is rejected with reason code 70 when Plan edit 9=Compounds set to 'N'and Set Compound Drig Status to R in NDC & GPI level(SN003374_SR41877_TC001_Req_8.1)
    ...
    # Update PlanCode, NDCList as per above,Carrier ID, CarrierName,AccountID, AccountName, Group Id, GroupName, MEMBERId,MemberFirst and last name, PANumeer and filldate 
     ...
     |Plnregr33|RDCL43   | R       | F       |88512606010  |88512705010   |010101   |123139   | SR4187C15 | SR4187C15   |712        |MAIL ADD  |City|IL   |78654|010101        |123139        |*DEFAULT   |*DEFAULT      |S41877A14  |S41877A14   | S41877G14 |S41877G14  |010101     |123139     | RS41877M52 |RS41877M52 |RS41877M52 |01011988 |010101     |123139     |SR41877P36|3   |00000000000000 |010101|123139 |O    |AC    |N               | 777777  | ASHE     |*      | APHARM      | 165488397000  | 00     | 112918   | 00000000000|30      |30  |0    | 100	 |100  |01          |1             |45        |00               |02          |2             |46        |01               |R          |R         |70        |Prod/Service Not Covered | 
...
Scenario Outline: Verify Compound claim is accepted for NDC Drug Status R when Member PA compound set to L(SN003374_SR41877_TC004_Req_8.1) #Use data from TC001 and Update the data for MemberId, MemberPA ID, 
     ...
     |Plnregr33|RDCL43   | R       | F       |88512606010  |88512705010   |010101   |123139   | SR4187C15 | SR4187C15   |712        |MAIL ADD  |City|IL   |78654|010101        |123139        |*DEFAULT   |*DEFAULT      |S41877A14  |S41877A14   | S41877G14 |S41877G14  |010101     |123139     | RS41877M53 |RS41877M42 |RS41877M42 |01011988 |010101     |123139      |SR41877P37|3   |00000000000000 |010101|123139 |O    |AC    |N               | 777777  | ASHE     |*      | APHARM      | 165488397000  | 00     | 112918   | 00000000000|30      |30  |0    | 100	|100  |01          |1             |45        |00               |02          |2             |46        |01               |R          |R         |70        |Prod/Service Not Covered  |Y      |P           |f          | 
...
Scenario Outline: Verify Compound claim is accepted for NDC Drug Status R when Member PA compound set to N and Y for Plan CMI is N (SN003374_SR41877_TC007_Req_8.1) #Update Member ID and PAnumber
     ...
     |Plnregr33|RDCL43   | R       | F       |88512606010  |88512705010   |010101   |123139   | SR4187C15 | SR4187C15   |712        |MAIL ADD  |City|IL   |78654|010101        |123139        |*DEFAULT   |*DEFAULT      |S41877A14  |S41877A14   | S41877G14 |S41877G14  |010101     |123139     | RS41877M57 |RS41877M57|RS41877M57  |01011988 |010101     |123139     |SR41877P42|3   |00000000000000 |010101|123139 |O    |AC    |N               | 777777  | ASHE     |*      | APHARM      | 165488397000  | 00     | 112918   | 00000000000|30      |30  |0    | 100	 |100  |01          |1             |45        |00               |02          |2             |46        |01              |P          |F         |Y      |P           |f          |N      | 
