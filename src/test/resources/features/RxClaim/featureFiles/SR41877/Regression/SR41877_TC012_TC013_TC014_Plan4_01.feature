...
Scenario Outline: Create a new Plan with NDC GPI List in RxClaim  
    ...
    |PlanReg14 |010110 |123139    |PlanReg14 NDCLST |EVUAREG      |EVUAREG           |RDCL02 |RDCL02  |20    |	010118  	  |123139        | L       |
...
Scenario Outline: Verify Compound claim is accepted for NDC when Member PA compound set to Y for Qty limit range(SN003374_SR41877_TC012_Req_8.1)
    ...
    # Update PlanCode, NDCList as per above,Carrier ID, CarrierName,AccountID, AccountName, Group Id, GroupName, MEMBERId,MemberFirst and last name, PANumeer and filldate   
     ...
     |PlanReg14|RDCL02   | F       | F       |88512606010  |88512705010   |010101   |123139   | 5      |10     | RR41877C8 | RR41877C8   |712        |MAIL ADD  |City|IL   |78654|010101        |123139        |*DEFAULT   |*DEFAULT      |SR41877A8  |SR41877A8   | SR41877G8 |SR41877G8  |010101     |123139     | RR41877M22 |RR41877M22 |RR41877M22  |01011988 |010101     |123139     |SR41877P18|3   |00000000000000 |010101|123139 |O    |AC    |N               | 777777  | ASHE     |*      | APHARM      | 165488397000  | 00     | 091018   | 00000000000|30      |30  |0    | 100	|100  |01          |20             |45        |00               |02         |30             |46        |01               |R          |F         |76        |Plan Limitations Exceeded |Y      |P           |f          | 
...
Scenario Outline: Verify Compound claim is accepted when Member PA compound set to Y for DS limt range(SN003374_SR41877_TC013_Req_8.1)
     ...
     |PlanReg14|RDCL02   | 88512606010 |88512705010 |010101   |123139   | 5      |10     | RR41877C8 | RR41877C8   |712        |MAIL ADD  |City|IL   |78654|010101        |123139        |*DEFAULT   |*DEFAULT      |SR41877A8  |SR41877A8   | SR41877G8 |SR41877G8  |010101     |123139     | RR41877M23 |RR41877M23 |RR41877M23  |01011988 |010101     |123139     |SR41877P19|3   |00000000000000 |010101|123139 |O    |AC    |N               | 777777  | ASHE     |*      | APHARM      | 165488397000  | 00     | 091018   | 00000000000|30      |30  |0    | 100	 |100  |01          |20             |45        |00               |02         |30             |46        |01               |R          |F         |76        |Plan Limitations Exceeded |Y      |P           |f          | 
 ...
 Scenario Outline: Verify Compound claim is accepted when Member PA compound set to Y for Age limt range(SN003374_SR41877_TC014_Req_8.1) #Update MemberId, PAnumber
     ...
     |PlanReg14|RDCL02   | 88512606010 |88512705010 |010101   |123139   | 5       |10      | RR41877C8 | RR41877C8   |712        |MAIL ADD  |City|IL   |78654|010101        |123139        |*DEFAULT   |*DEFAULT      |SR41877A8  |SR41877A8   | SR41877G8 |SR41877G8  |010101     |123139     | RR41877M24 |RR41877M24 |RR41877M24  |01011991 |010101     |123139     |SR41877P20|3   |00000000000000 |010101|123139 |O    |AC    |N               | 777777  | ASHE     |*      | APHARM      | 165488397000  | 00     | 091018   | 00000000000|30      |30  |0    | 100	 |100  |01          |20            |45        |00               |02         |30            |46        |01               |R          |F         |76        |Plan Limitations Exceeded  |Y      |P           |f          | 
