...
As a RxClaim User I want to check claim is paid and POS rebate are deducted properly 
  ...
  Scenario Outline: To check if the POS rebate is adjusted from  the DFT components only when there are both the fixed as well as %DFT for a MI compound claim 
   	...
   	Then I edit the patient pay table with "<PatPayTable>","      ","<BrandPercent>","      ","<CalcBasis>","<GenericPercent>","<CompCode>"
   	And I press "F12" Key
    ...
    Then Validate Claim Status is "P"
      ...
      | SR4141603 | Carrier     |        712 | MAIL ADD   | Hyderabad | IL    | 78654 |         010101 |         123139 | *DEFAULT    | *DEFAULT     | SR41787A1 | Account     | SR4141603 | Group   |  010101     |      123139 | SR41416_P6 | SR41416_06 | AUTOMEM    | AUTOMEM   | 12251987 | 777777 | CCHA | *ALL    | APHARM | 000019924000 | 00     | 8132018   | 0000000000 |10      |10  |0   |100   | 60 | 010101 | SN003350C | SN003350 | 7 | SN003350 | G | SN003350 | CZINFAMILY  | 010101 | 123139 | 320 | SN003350P1 | 20 | 20 | 20 | 02 | 20 | B | N | 00847009501 | 00847059806 | 10 | 100 | 1 |
