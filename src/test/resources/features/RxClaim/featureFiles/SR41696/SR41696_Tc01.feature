...
As a RxClaim User I want to cVerify whether for a paid claim that have multiple sequences display the sequence with the highest calculated MED amount
   ...
   Scenario Outline: Verify whether for a paid claim that have multiple sequences display the sequence with the highest calculated MED amount
    ...
    Examples:
    | CarrierID | AccountID   | GroupID     |Plan1     | MemberID  | FirstName | LastName | DOB      | FromDate | ThruDate | BIN     | ProcCtrl| Group | PharmacyID  |RxNo          | Refill | FillDate   | ProductID  | DspQty | DS | PSC | Cost      |Qual|Prescid|DS1|PSC1|RxNo1|
		...
		|	NARESH01  | NARESH_ACC01 |NARESH GRP  |SR41696| MEMSR47000 | AUTOMEM    | AUTOMEM   | 12251987	| 010101    | 123139      |	777777  | QET     |	*ALL  | 0556540      | 765466702232 | 00     | 091118    | 59011042020  |10     |7  |00   |100   |12  |AL4392748|10|3|765224577832|