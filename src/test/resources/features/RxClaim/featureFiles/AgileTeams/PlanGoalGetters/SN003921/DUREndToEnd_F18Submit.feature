...
@Regression
@PlanDUR
Feature: Create data setup for DUR scenarios
As a RxClaim User I want to setup the data
  ...
  Scenario Outline: TC01_US1422900_User submits a claim  via F18 for a member WHEN there is a DUR Table defined in the member's plan and the NDC/GPI override within F22=Medicaid has a DUR table attached and the DUR override is set to 'Y'. The drug submitted is not found in the Medicaid DUR table    
    ...
    And I submit a DUR claimone with "<BIN>","<ProcCtrl>","<Group>","<PharmacyID>","<RxNo>","<Refill>","<FillDate>","<MemberID>","<ProductID1>","<DspQty>","<DS>","<PSC>",
    ...
    @TS9
  Scenario Outline: TC02_US1422900_User submits a claim  via F18 for a member WHEN there is a DUR Table defined in the member's plan and the NDC/GPI override within F22=Medicaid has a DUR table attached and the DUR override is set to 'Y'.   The drug submitted is not found in the Medicaid DUR table.    
    
    Given I am on RxClaim PlanAdministrator Menu
    When I submit a DUR claimone with "<BIN>","<ProcCtrl>","<Group>","<PharmacyID>","<RxNo>","<Refill>","<FillDate>","<MemberID>","<ProductID1>","<DspQty>","<DS>","<PSC>",
  ...
  @TS10
  Scenario Outline: TC03_US1422900_User submits a claim  via F18 for a Medicare member WHEN there is a DUR Table defined in the member's plan     
   ...
   @TS11
  Scenario Outline: TC04_US1422900_User submits a claim  via F18 for a Medicare member WHEN there is a DUR Table defined in the member's plan     
  ...
  @TS12
  Scenario Outline: TC05_US1422900_User submits a claim  via F18 for a member WHEN there is a DUR Table defined in the member's plan and the NDC/GPI override within F22=Medicaid has a DUR table attached and the DUR override is set to 'Y'. The drug submitted is found in the Medicaid DUR table
    ...
    And I submit a DUR claimone with "<BIN>","<ProcCtrl>","<Group>","<PharmacyID>","<RxNo>","<Refill>","<FillDate>","<MemberID>","<ProductID1>","<DspQty>","<DS>","<PSC>",
        Then I validate the claim status with "<ClaimStatus>"
    When I submit a DUR claimone with "<BIN>","<ProcCtrl>","<Group>","<PharmacyID>","<RxNo>","<Refill>","<FillDate2>","<MemberID>","<ProductID1>","<DspQty>","<DS>","<PSC>", 
 				Then I validate the DUR Claimone details with "<ClaimStatus2>","<RejCode>","<DURTable2>","<DurServiceType>","<Message1>","<Message2>","<DURMessage>"
 		When I submit a DUR claimone with "<BIN>","<ProcCtrl>","<Group>","<PharmacyID>","<RxNo>","<Refill>","<FillDate3>","<MemberID>","<ProductID1>","<DspQty>","<DS>","<PSC>", 
 				Then I validate the claim status with "<ClaimStatus>"
   ...
   @TS13
  Scenario Outline: TC06_US1422900_User submits a claim  via F18 for a member WHEN there is a DUR Table defined in the member's plan and the NDC/GPI override within F22=Medicaid has a DUR table attached and the DUR override is set to 'Y'.   The drug submitted is found in the Medicaid DUR table.    
    ...
    @TS14
  Scenario Outline: TC07_US1422900_User submits a claim  via F18 for a member WHEN there is a DUR Table defined in the member's plan and the NDC/GPI override within F22=Medicaid does not have a DUR table attached and the DUR override is set to 'N'.     
  ...
  Scenario Outline: TC08_US1422900_User submits a claim  via F18 for a member WHEN there is a DUR Table defined in the member's plan and the NDC/GPI override within F22=Medicaid does not have a DUR table attached and the DUR override is set to 'N'.      
   ...
   @TS16
  Scenario Outline: TC09_US1422900_User submits a claim  via F18 for a member WHEN there is a DUR Table defined in the member's plan and the NDC/GPI override within F22=Medicaid does not have a DUR table attached and the DUR override is set to 'blank'.       
   ...
   @TS17
  Scenario Outline: TC10_US1422900_User submits a claim  via F18 for a Medicare member WHEN there is a DUR Table defined in the member's plan subsequent of Medicaid plan with DUR override in place.    
    ...
    And I submit a DUR claimone with "<BIN>","<ProcCtrl>","<Group>","<PharmacyID>","<RxNo>","<Refill>","<FillDate>","<MemberID1>","<ProductID1>","<DspQty>","<DS>","<PSC>",
    	Then I validate the claim status with "<ClaimStatus>"
    When I submit a DUR claimone with "<BIN>","<ProcCtrl>","<Group>","<PharmacyID>","<RxNo>","<Refill>","<FillDate>","<MemberID2>","<ProductID1>","<DspQty>","<DS>","<PSC>",       
      Then I validate the claim status with "<ClaimStatus>"
   ...
   @TS18
  Scenario Outline: TC11_US1422900_User submits a claim  via F18 for a Medicare member WHEN there is a DUR Table defined in the member's plan subsequent of Medicaid plan with DUR override in place.       
    
    Given I am on RxClaim PlanAdministrator Menu    
    And I submit a DUR claimone with "<BIN>","<ProcCtrl>","<Group>","<PharmacyID>","<RxNo>","<Refill>","<FillDate>","<MemberID2>","<ProductID1>","<DspQty>","<DS>","<PSC>",
