...
As a RxClaim User I want to check claim is paid and validate the DFTI
  ...
  Scenario Outline: Verify that the logic for Additional Patient Pay Schedule Basis ‘C’ in DMR processing is updated for Plan type A- OON differential applied, Vaccine fee applied, Dispensing Fee NOT calculated, Submitted DFT > Calculated DFT and Drug Spend Total is correct in TrOOP/Drug Spend Accumulation Phase for Plan type A- OON differential applied
...
|SR41720DCH|80| SR41720A5 |  AUTOMEM    | AUTOMEM   |900019951000|49281040015|1|1|0|200|200|200|45|