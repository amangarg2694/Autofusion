...
Scenario Outline: SN003331_SR41449_TC001_Verify Change Plan edit for Member Eligibility when update flag set to N and Member Eligibility set to D
    ...
    When I enter query
	  ...
	  Then I verify Change Plan edit for Member Eligibility "<MemberEligibility>" when update flag set to N and Member Eligibility set to D
		# CALL PGM(RCPLN711) PARM('')  
		       
    Examples: 
      | PlanCode  | FromDate | MemberEligibility  | Flag	|	DynamicPA	|
      | SN003562A | 010118	 | Y									|	N			|	D					|
