...
Scenario Outline: SN003562_SR41760 _TC018_RCPME_Change_N_Invalid: Verify Change Member Eligibility (PME) record when Update flag set N.
									SN003562_SR41760 _TC020_RCPME_Change_YL_Blank: Verify Change Member Eligibility (PME) record when Update flag set Y.
									SN003562_SR41760 _TC019_RCPME_Change_YL_valid: Verify Change Member Eligibility (PME) record when Update flag set Y.
    ...
    Examples: 
      | PlanCode  	| FromDate | RunMode  |	PriorAuth	|	Position20	|	Position21	|	Position354	| PACarrierList		|
     	| SN003562A1	| 010118	 | C				|	G					|	N						|	L						|	N						|	asf$%%as				|
     	| SN003562A1	| 010118	 | C				|	G					|	Y						|	L						|	Y						|	asf$%$%as				|
			| SN003562A1	| 010118	 | C				|	G					|	Y						|	L						|	Y						|	SN1629LST1			|
