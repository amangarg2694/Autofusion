...
Scenario Outline: SN003331_SR41449_TC006_Verify Change Plan edit for Member Eligibility when update flag set to Y and Member Eligibility set to P
    ...
    When I enter query
	  ...
	  And I navigate to "<PlanCode>" Plan Details Page
		Then I verify Change Plan edit for Member Eligibility "<MemberEligibility>" when update flag set to Y and Member Eligibility set to P
		# CALL PGM(RCPLN711) PARM('')       
		   
    Examples: 
      | PlanCode  | FromDate | MemberEligibility  | Flag	|	DynamicPA	|
      | TESTLFT99 | 010118	 | Y									|	Y			|	P					|
