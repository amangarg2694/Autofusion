...
Scenario Outline: SN003562_SR41760 _TC017_RCPME_Change_N_Blank: Verify Change Member Eligibility (PME) record when Update flag set N.
    ...
    Examples: 
      | PlanCode  	| FromDate | RunMode  |	PriorAuth	|	Position20	|	Position21	|	Position354	| PACarrierList		|
    	| SN003562A1	| 010118	 | C				|	G					|	N						|	L						|	N						|	SN1629LST1			|
