...
Then I validate the fields in the screen FIR Rejected Transaction Detail File

#Enter existing Carrier,Library
Examples:
| FIRFdate | FIRTdate|CarrierFrom|CarrierThru|Filename  |Library|
| 010101   |123139   |SR41010AA  |SR41010A1  |S42094F01 |USRSAKK| 
