Feature: Submit a claim with Retail and Mail Pharmacy
  ...
  Scenario Outline: Submit a claim in RxClaim
    ...
    Examples: 
      | BIN    | ProcCtrl | Group | PharmacyID | RxNo         | Refill | FillDate | MemberID     | ProductID   | DspQty | DS | PSC | Cost | PreQual | PreID      | UCW  | ABC    |
      | 777777 | QET      | *ALL  |    0556540 | 765488397611 |     00 |   060116 | AUTOMEMBER01 | 00777310402 |     30 | 30 |   1 | 1000 |      01 | 1821039694 | 1000 | Dinesh |
