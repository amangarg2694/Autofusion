...
As a RxClaim User I want to Verify the Part D Update Manufacturer Discount and Biosimilar Coverage in Gap
   ...
   |SN003565P1|SRTSTCOPY6|1/01/18|12/31/18|MPD BIOS|MPD BIOS|N|N|N|
   ...
   |N|New value of Coverage Gap Discount.|
   ...
   |N|New value of LICS Generic Cost-Share.|
   ...
   |N|New value of Non-LICS Catastrophic Generic Cost-Share.|
   ...
   Scenario Outline: Verify error message on Plan Biosimilar Product List Create Record Detail screen with Action = Add 
    ...
    Examples:
   |NDCList|GPIList|ErrorMsg|
   |TESTNDCEXC|TESTBSAM01|At least one list must be populated.|
   ...
   |.00|Gap Eligible Amount for Manufacturer Discount. If product qualifies but member is a LICS member, this amount is still calculated but manufacturer discount will not be applied. If product does not qualify, this amount is $0.00.|