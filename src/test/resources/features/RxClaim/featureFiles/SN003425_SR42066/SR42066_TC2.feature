 ...
 #@Regression
  Scenario Outline: SN003425_SR42066_TC001_Req 4.2:Validate the compound code on PDE 1080 when the PDE  is submitted for a cliam with compound code  0
    ...
    |Cmpnd|BIN    |ProcCtrl|Group |PharmacyID|RxNo         |Refill |FillDate |MemberID	  |ProductID  |DspQty |DS |PSC |Cost |ExtractDate |wsQuery|ExtractJobName|Extractstatus|FromDate|ThruDate|CarrierID|Library|DDPSFilterProcess|SubmitterID|Compoundcode|JobRCPD 	|Fromfile |Option|Createfile|InputFileName|DDPSFilterProcessR|
	 ...
	 #|1		|777777 |QET     |*ALL  |APHARM    |765765367432 |00     |060118   |SR42066AUTO1|00777310402|30     |30 |00  |100  |112818		  |ws		  |EXTRACTJOB		 |BLANK				 |010118  |123138	 |SR42066C |ANMISHA|N							   |T42066	   |1 			  	|RCPD1070	|
	 #|2		|777777 |QET     |*ALL  |APHARM    |765765367432 |00     |060118   |SR42066AUTO1|00777310402|30     |30 |00  |100  |112818		  |ws		  |EXTRACTJOB		 |BLANK				 |010118  |123138	 |SR42066C |ANMISHA|N							   |T42066	   |2				  	|RCPD1070	|
