...
As a RxClaim User I want to check claim is paid and POS rebate are deducted properly 
  ...
  Scenario Outline: To check if the POS rebate is adjusted from all the DFT components in the deductible and the copay rules 
   	...
   	Then I edit the patient pay table with "<PatPayTable>","<BrandAmt>","<BrandPercent>","<GenericAmt>","<CalcBasis>"
   	And I press "F12" Key
