...
And I submit a Reversal claim with Retail  "<BIN>","<ProcCtrl>","<Group>","<PharmacyID>","<RxNo>","<Refill>","<FillDate>","<MemberID>","<ProductID>","<DspQty>","<DS>","<PSC>","<Cost>","<rxorg>"
And Validate Claim Status is "X"
And I get the network id value from the reversed claim
And I am on RxClaim PlanAdministrator Menu
