...
And I navigate to the plan "<Plan1>" to copy to new plan "<Plan2>"
And I select "Pharmacy Network" option in "<Plan1>"
...
#And I enter override plan on MemberdetailScreen
And I press "Enter" Key
...
Examples: 
|Plan1   |Plan2   |CarrierID | AccountID   | GroupID     | MemberID  | First Name | Last Name | DOB      | From Date | Thru Date | BIN     | ProcCtrl| Group | PharmacyID  |RxNo          | Refill | FillDate | ProductID  | DspQty | DS | PSC | Cost |rxorg| 
|RUSH_TEST|41876_P6|SN3513    |SN3513_A     |	SN3513_G    | 3513_MEM6 | AUTOMEM    | AUTOMEM   | 12251987	| 010101    | 123139    |777777   |ASHE     |*      |EVUSTD       |122114434646  |00      |081718    | 00591571501|30      |30  |00   |100   |1|