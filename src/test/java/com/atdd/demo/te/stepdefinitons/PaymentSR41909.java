...
public class PaymentSR41909 
{
                ...
                @When("^I add process with \"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\"$")
                public void i_add_process_with(String Process, String ProcessDescription, String ProcessType, String Cycle, String ProcessFromDate,String ProcessThruDate) throws Throwable {
                                ...
                                FunctionalLibrary.pressEnter();
                                Mainframe_GlobalFunctionLib.sendText(10,25,ProcessFromDate+"  ");
