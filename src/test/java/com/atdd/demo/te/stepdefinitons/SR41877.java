...
public class SR41877 {
	...
	public void i_validate_the_status_for_Claim(String ClaimStatus, String DrugStatus, String RejectCode, String RejectMessage) throws Throwable {
		...
		Reporter.addScreenCaptureFromPath(Screenshot.screenshot());
		Mainframe_GlobalFunctionLib.validateText("6", "37", ClaimStatus);
		String ActClaimStatus2 = Mainframe_GlobalFunctionLib.getText(6, 37);
		System.out.println("Actual Claim Status: "+ActClaimStatus2);
		
		Mainframe_GlobalFunctionLib.validateText("7", "26", DrugStatus);
		String ActDrugStatus2 = Mainframe_GlobalFunctionLib.getText(7, 26);
		System.out.println("Actual Drug Status: "+ActDrugStatus2);
		
		Mainframe_GlobalFunctionLib.validateText("18", "2", RejectCode);
		String ActRejCode2 = Mainframe_GlobalFunctionLib.getText(18, 2);
		System.out.println("Actual Rejected Code: "+ActRejCode2);
		
		Mainframe_GlobalFunctionLib.validateText("18", "7", RejectMessage);
		String ActRejMessage2 = Mainframe_GlobalFunctionLib.getText(18, 7);
		System.out.println("Actual Rejected Code Message: "+ActRejMessage2);
