...
public class UpdatesToTheDrugDataProcessingSystem {
	...
	public void i_verify_the_Extract_status_in_Claim_Transaction_Additional_Info(String Extractstatus) throws Throwable {
		...
		{
			System.out.println("Expected RxClaim ID Found: "+rxClaimIdValue);
			Reporter.addStepLog("Expected RxClaim ID Found: "+rxClaimIdValue);
			Reporter.addScreenCaptureFromPath(Screenshot.screenshot());
	...
	try{ 
		 Mainframe_GlobalFunctionLib.sendText(5, 29, TofileName);
