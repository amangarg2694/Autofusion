...
public class TransactionSubmissionWithPayeeOverride {
	...
	@When("^I create a subrogation transaction with \"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\"$")
	public void i_create_a_subrogation_transaction_with(String bin, String pcn, String group, String pharmacy, String refill,String fillDate, String memberID, String payeeOverride, String subrogationFlag, String productID, String dspQty, String ds, String psc, String cost, String due, String ucw,String fee) throws Throwable {
	   	try{
	    		FunctionalLibrary.navigateToScreen("3");
	    		FunctionalLibrary.navigateToScreen("2");
	    		FunctionalLibrary.navigateToScreen("10");
	    ...
	    @When("^I go to transaction compound detail screen$")
	    public void i_go_to_transaction_compound_detail_screen() throws Throwable {	  
	    		Mainframe_GlobalFunctionLib.pressKey("F14");
				Mainframe_GlobalFunctionLib.sendText(5, 23,"5" );
				Mainframe_GlobalFunctionLib.pressKey("Enter");
	    	}

	    @When("^I add compound Detail with \"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\"$")
	    public void i_add_compound_Detail_with(String compQualID, String compProductID, String compQuantity, String compCost, String compBasisOfCost) throws Throwable {
	    	Mainframe_GlobalFunctionLib.pressKey("F6");
	    ...
	    public void i_submit_the_claim() throws Throwable {	        
	    	FunctionalLibrary.submitClaim();
	    }
