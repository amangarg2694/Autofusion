...
public class FunctionalLibrary extends CommonHelper {
	...
	public static void createCAG(String carrierID, String carrierName, String processor, String mail, String city,
			...
			String gFromDate, String gThruDate, String planCode) throws Throwable {
		try {
	...
	// ,String accountID,String accountName ,String groupID,String
	// groupName,String gFromDate,String gThruDate,String planCode) throws
	// Throwable
	{
		try {
			navigateToRxClaimPlanAdministrator();
	...
	public static void addGroup(String carrierID, String accountID, String groupID, String groupName, String gFromDate,
			String gThruDate, String planCode) throws IOException { // Create
																	// new group
	...
	public static void CreateMember(String carrierID, String accountID, String groupID, String memberID,
	...
	// PA Member
	public static void CreateMemberPA(String carrierID, String accountID, String groupID, String memberID,
			String firstName, String lastName, String dob, String fromDate, String thruDate) throws Throwable {
		try {
			navigateToRxClaimPlanAdministrator();
		} catch (Exception e) {
	...
	public static void SetSupplementalIDbyType(String SupplementalIDFromDate, String SupplementalIDThruDate,
	...
	public static void func_SetMedicare(String memberID, String PARTDfromdate, String PARTDthrudate, String contract,
	...
	public static void SetPBP(String carrierID, String contract, String pbp, String benefityear, String medicaretype)
			throws Throwable {
		try {
			navigateToRxClaimPlanAdministrator();
		} catch (Exception e) {
	...
	public static void func_SetPartDMasterProfileDetail(String carrierID, String accountID, String groupID,
			String plancode, String fromdate, String masterprofilefromdate, String masterprofilethrudate,
	...
	public static void SetPatientPaySchedule(String PPdetailschedule, String PPdetaildescription,
			String planusequalifier) throws Throwable {
		try {
			navigateToRxClaimPlanAdministrator();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void Createplanwithmembereligibilityandpricingoption(String plancode, String fromdate,
		...
		try {
			...
			Reporter.addScreenCaptureFromPath(Screenshot.screenshot());
			Assert.fail(
					"The Plan edit 2 Member Eligibility and 28 Pricing are not set successfully.Screenshot is captured");
		}
	}

	public static void func_setMemberEligibility()
	...
	public static void func_setPricing()
			throws ClassNotFoundException, GeneralLeanFtException, SQLException, ReportException, InterruptedException {
		Mainframe_GlobalFunctionLib.sendText(13, 77, "Y");
		Mainframe_GlobalFunctionLib.pressKey("Enter");
		Mainframe_GlobalFunctionLib.sendText(16, 64, "Y");
	...
	public static void Createplanwithpricing(String plancode, String fromdate, String description, String thruDate,
	...
	public static void SetupPlanEdit10(String plancode, String ndclist, String ndcfromdate, String ndcstatus)
			throws Throwable {
		try {
			navigateToRxClaimPlanAdministrator();
		} catch (Exception e) {
	...
	public static void PlanWithNDCList(String plancode, String ndclist, String ndcsq, String ndcfromdate,
	...
	public static void CreatePlanWithNDCList(String ndclist, String ndcsq, String ndcfromdate, String ndcthrudate)
			throws Throwable {
	...
	public static void PlanWithGPIList(String plancode, String gpilist, String gpisq, String gpifromdate,
	...
	public static void SetupPlanEdit15(String plancode, String maxrefill, String period, String effectivedate)
			throws Throwable {
		try {
			navigateToRxClaimPlanAdministrator();
		} catch (Exception e) {
	...
	public static void addAccumulators(String TrOOPfromdate, String TrOOPthrudate, String accumulationlevel,
		...
		try {
			...
			/*
			 * System.out.println("size of Accumulation Code"+accumulationcode.
			 * length()); if(accumulationcode.length()>0) {
	...
	public static void SetCoveredPlanPaidAmount(String CPPFromDate, String CPPThruDate, String CPPAccumulationLevel,
			String CPPAccumulationCode, String CPPPatientPaySchedule, String CPPTrOOPSchedule, String Qualifier)
			throws Throwable {
		try {
	...
	public static void func_CreatePlanWithRefill(String plancode, String maxrefill, String period, String effectivedate)
			throws Throwable {
		try {
			navigateToRxClaimPlanAdministrator();
		} catch (Exception e) {
	...
	public static void CreateTransaction(String bin, String proc, String group, String pharmacyID, String rxNbr,
	...
	public static void CreateTransactionRetailMOPharmacy(String bin, String proc, String group, String pharmacyID,
	...
	// Compound Claim
	public static void createCompoundClaim(String bin, String proc, String group, String pharmacyID, String rxNbr,
			String refill, String fillDate, String memberID, String productId, String dspQty, String ds, String psc,
	...
	public static void compoundClaimWithMultiIngredient(String bin, String proc, String group, String pharmacyID,
			String rxNbr, String refill, String fillDate, String memberID, String productId, String dspQty, String ds,
			String psc, String cost, String prequal, String preid, String ucw, String compQualID_1,
			String compProductID_1, String compQuantity_1, String compCost_1, String compBasisOfCost_1,
			String compQualID_2, String compProductID_2, String compQuantity_2, String compCost_2,
			String compBasisOfCost_2) throws Throwable {
		try {
			navigateToRxClaimPlanAdministrator();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void submitClaimF18WithoutRxOrigin()
	...
	public static boolean func_SearchAndSelectADataEditMode(String RowColOfData, String Data,
			String StartRowColToSearch, String DataSearch) throws IOException {
		boolean bRes = false;
		try {
			...
			if (Mainframe_GlobalFunctionLib.getText(row, Integer.parseInt(col)).trim().toLowerCase()
					.contentEquals(DataSearch.trim().toLowerCase())) {
	...
	public static boolean func_SearchAndSelectMode(String RowColOfData, String Data, String StartRowColToSearch,
			String DataSearch) throws IOException {
		boolean bRes = false;
		try {
	...
	public static boolean func_SearchAndEditContractAndPBP(String contract, String pbp) throws IOException {
		...
		try {
			...
			/*
			 * StringTokenizer stData=new StringTokenizer(RowColOfData,",");
			 * StringTokenizer stDataSearch=new
			 * StringTokenizer(StartRowColToSearch,",");
			 */
			// int row=Integer.valueOf(stDataSearch.nextToken());
			// String col=stDataSearch.nextToken();

			// Mainframe_GlobalFunctionLib.sendText(stData.nextToken(),stData.nextToken(),
			// Data);
			...
			if (Mainframe_GlobalFunctionLib.getText(10, 5).trim().toLowerCase()
					.contentEquals(contract.trim().toLowerCase())
					&& Mainframe_GlobalFunctionLib.getText(10, 15).trim().toLowerCase()
							.contentEquals(pbp.trim().toLowerCase())) {
	...
	public static boolean func_SearchAndEditProfileAndType(String profile, String type) throws IOException {
		...
		try {
			...
			Mainframe_GlobalFunctionLib.pressKey("Enter");
			if (Mainframe_GlobalFunctionLib.getText(9, 5).trim().toLowerCase()
					.contentEquals(profile.trim().toLowerCase())
					&& Mainframe_GlobalFunctionLib.getText(9, 50).trim().toLowerCase()
							.contentEquals(type.trim().toLowerCase())) {
				bRes = true;
				Mainframe_GlobalFunctionLib.sendText(10, 2, "2");
				Mainframe_GlobalFunctionLib.pressKey("Enter");
				Thread.sleep(2000);
	...
	public static boolean func_SearchAndSelectContractAndPBP(String contract, String pbp) throws IOException {
		...
		try {
			...
			Loop: for (int i = 10; i <= 11; i++) {
				...
				if (Mainframe_GlobalFunctionLib.getText(i, 5).trim().toLowerCase().contains(contract.toLowerCase())
						&& Mainframe_GlobalFunctionLib.getText(i, 16).trim().toLowerCase()
								.contains(pbp.toLowerCase())) {
	...
	public static boolean func_SearchAndEditPartDMasterProfile(String carrierID, String accountID, String groupID,
			String plancode) throws IOException {
		...
		try {
			...
			Loop: for (int i = 9; i <= 10; i++) {
				...
				if (Mainframe_GlobalFunctionLib.getText(i, 5).trim().toLowerCase().contains(carrierID.toLowerCase())
						&& Mainframe_GlobalFunctionLib.getText(i, 16).trim().toLowerCase()
								.contains(accountID.toLowerCase())
						&& Mainframe_GlobalFunctionLib.getText(i, 33).trim().toLowerCase()
								.contains(groupID.toLowerCase())
						&& Mainframe_GlobalFunctionLib.getText(i, 50).trim().toLowerCase()
								.contains(plancode.toLowerCase())) {
	...
	public static boolean func_SearchForMemberID(String RowColOfData, String Data, String StartRowColToSearch,
			String DataSearch) throws IOException {
		boolean bRes = false;
		try {
	...
	public static void enterText(String fieldValue, String fieldName, String screenName) throws Exception {
		try {
			...
			// test.log(LogStatus.PASS,"Entered text in field "+ fieldName+" on
			// screen "+screenName
			// ,test.addScreenCapture(Screenshot.screenshot()));
			Reporter.addStepLog("Entered text in field " + fieldName + "at position " + coordinates[0] + ","
					+ coordinates[1] + " on screen " + screenName);
			if (ScreenshotOption.equalsIgnoreCase("Always")) {
				Reporter.addScreenCaptureFromPath(Screenshot.screenshot());
			}
		} catch (Exception e) {
			Reporter.addScreenCaptureFromPath(Screenshot.screenshot());
			// Reporter.addStepLog(Assert.fail("The text is not
			// entered.Screenshot captured");
	...
	public static void validateText(String row, String col, String text) throws IOException {
		try {
			...
			if (ScreenshotOption.equalsIgnoreCase("Always")) {
				Reporter.addScreenCaptureFromPath(Screenshot.screenshot());
				// if( b == false)
				// Assert.fail("The text "+ text +" does not match on the
	...
	public static String func_GetJulianDateFromCurrentDate() throws Throwable {
		...
		int J = 1451 * (Y1 + M1) / 4 + 367 * (M - 2 - 12 * M1) / 12 - (3 * ((Y1 + M1 + 100) / 100)) / 4 + D - 32075;
	...
	public static String func_GetCurrentMonth() throws Throwable {
		try {
			...
			// logInfo("<font size=2 face=Tahoma Color=Red>File
			// Name:SAPDate,Error at Line Number: " +
			// Thread.currentThread().getStackTrace()[2].getLineNumber()+"</font>");
			throw e;
		}
	}
	...
	// Set PA without MNC and OTC
	public static void func_SetPriorAuth(String number, String type, String ndcgpilist, String from, String thru,
	...
	public static void submitsqlquerywithftp(String filename, String libraryname, String FTPCmd)
			throws ClassNotFoundException, GeneralLeanFtException, SQLException, ReportException, InterruptedException {
		...
		Mainframe_GlobalFunctionLib.pressKey("Enter");
		Mainframe_GlobalFunctionLib.pressKey("F12");
		Mainframe_GlobalFunctionLib.sendText(5, 7,
				"SELECT RXCLAIMNBR,MBRFSTNME,MBRLSTNME,MBRBIRTH,MEMBERID,MBRZIP FROM clmprdext2/rce11808 WHERE DATESBM ='20180826' and CARRIERID = 'PSI2500'and CLAIMSTS = 'P'");
		Mainframe_GlobalFunctionLib.pressKey("Enter");
		Mainframe_GlobalFunctionLib.pressKey("F12");
	...
	public static void submitjobcmd()
			throws ClassNotFoundException, GeneralLeanFtException, SQLException, ReportException, InterruptedException {
				...
				try {
					if (row < lastrow) {
						...
						try {
							...
							if (getValue != null && getValue != "" && !getValue.isEmpty()
	...
	public static void compareText(String actualValue, String expectedValue) throws IOException {
		try {
			...
			if (actualValue.trim().equals(expectedValue.trim())) {
				...
				Assert.fail("The actual text " + actualValue + " does not match with expected text " + expectedValue
						+ " .Screenshot captured.");
			}
			if (ScreenshotOption.equalsIgnoreCase("Always")) {
				Reporter.addScreenCaptureFromPath(Screenshot.screenshot());
	...
	public static void main(String args[]) throws Throwable {
		...
		// fb.login();
		fb.createCAG("TESTAUTC2", "Test Carrier", "9999999999", "MAIL ADD", "City", "IL", "78654", "010101", "123139",
				"*DEFAULT", "*DEFAULT", "TESTAUTA1", "Test Account", "TE124", "Test Group", "010101", "123139",
				"AUTOEGWP");
		...
		// fb.CreateTransaction("777777","QET","*ALL", "APHARM","765488367432",
		// "00", "060116", "AUTOMEM0012","00777310402","30","30","00","100");
		// fb.submitClaim();
